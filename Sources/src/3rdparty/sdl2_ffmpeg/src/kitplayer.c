...
#include "sdl2_ffmpeg/internal/audio/kitaudio.h"
...
Kit_Player* Kit_CreatePlayer(const Kit_Source *src,
    ...
    player->decoders[KIT_VIDEO_DEC] = Kit_CreateVideoDecoder(src, video_stream_index, rVideoType);
...
int Kit_GetPlayerVideoSDLData(Kit_Player *player, SDL_Texture *texture) {
    assert(player != NULL);
    ...
    return Kit_GetVideoDecoderSDLData(dec, texture);
}

int Kit_GetPlayerVideoOpenGLData(Kit_Player *player, unsigned int gltexture) {
    assert(player != NULL);
    ...
    return Kit_GetVideoDecoderOpenGLData(dec, gltexture);
}

int Kit_GetPlayerVideoOpenCVData(Kit_Player *player, uint8_t * pData) {
    assert(player != NULL);
    ...
    return Kit_GetVideoDecoderOpenCVData(dec, pData);
}


int Kit_GetPlayerVideoOpenCVData2(Kit_Player *player, uint8_t * pYUVData) {
    assert(player != NULL);
    ...
    return Kit_GetVideoDecoderOpenCVData2(dec, pYUVData);
}



int Kit_GetPlayerVideoYUV2OpenGLData(Kit_Player *player, uint8_t * pData) {
    assert(player != NULL);
    ...
    return Kit_GetVideoDecoderYUV2OpenGLData(dec, pData);
}
