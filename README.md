...
# miniDart (version actuelle au téléchargement : 0.9.1 (Windows7+ seulement) , devel : 0.9.2)
...
**Ce qui est actuellement fonctionnel** (dans la version 0.9.1 à venir prochainement) :
...
#miniDart (current version: 0.9.1 for Windows, devel 0.9.2)
